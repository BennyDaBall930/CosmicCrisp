...
def main():
    cosmic_crisp_agent_py = read_file_content('agent.py')
    agent_zero_agent_py = read_file_content('/Users/benjaminstout/Desktop/agent-zero-0.9.6/agent.py')
...
"""
    ...
    print("Generated initial human-readable report.")
