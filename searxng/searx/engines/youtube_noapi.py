...
# It is recommended to provide the API key through a configuration file
# and not hardcode it in the source.
next_page_url = 'https://www.youtube.com/youtubei/v1/search?key=YOUR_API_KEY'
