...
def print_troubleshooting():
    ...
    print("   - Make sure Apple Zero is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Apple Zero server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Apple Zero server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Apple Zero server if not running")
