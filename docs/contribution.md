# Contributing to Apple Zero
Apple Zero is an AI agent framework based on the open-source project Agent Zero.


Contributions to improve Apple Zero are very welcome!  This guide outlines how to contribute code, documentation, or other improvements.
...
1. **Fork the Repository:** Fork the Apple Zero repository on GitHub.
...
* **Code Style:** Follow the existing code style. Apple Zero generally follows PEP 8 conventions.
...
2. **Create a Pull Request:** Create a pull request from your branch to the appropriate branch in the main Apple Zero repository.
...
- The documentation is built using Markdown. We appreciate your contributions even if you don't know Markdown, and look forward to improve Apple Zero for everyone's benefit.