            ...
            try {
                ...
                if (data.success && data.tunnel_url) {
                    ...
                    if (this.tunnelLink !== data.tunnel_url) {
                        ...
                        localStorage.setItem('apple_zero_tunnel_url', data.tunnel_url);
                    }
                    ...
                    const storedTunnelUrl = localStorage.getItem('apple_zero_tunnel_url');
                    ...
                    if (storedTunnelUrl) {
                        ...
                        if (verifyData.success && verifyData.is_valid) {
                            ...
                            // Clear stale URL
                            localStorage.removeItem('apple_zero_tunnel_url');
                            this.tunnelLink = '';
            ...
            try {
                ...
                if (!hasAuth) {
                    const proceed = confirm(
                        "WARNING: No authentication is configured for your Apple Zero instance.\n\n" +
                        "Creating a public tunnel without authentication means anyone with the URL " +
                        "can access your Apple Zero instance.\n\n" +
