...
async function startPolling() {
  // Back off polling to reduce request pressure on the server.
  // Use brief bursts when updates are flowing, otherwise fall back to ~1s.
  const shortInterval = 150;
  const longInterval = 900;
  const shortIntervalPeriod = 30; // ~4.5s of burst at 150ms
