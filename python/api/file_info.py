...
async def get_file_info(path: str) -> FileInfo:
    ...
    in_base = abs_path.startswith(base_dir + "/") or abs_path == base_dir
    browser_path = ""
    if in_base:
        # Convert to path relative to project root for the File Browser
        browser_path = os.path.relpath(abs_path, base_dir)
